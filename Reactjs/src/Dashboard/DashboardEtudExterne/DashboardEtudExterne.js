...
import { RecoveryEtudExterne } from './externe';




const DashbordEtudExterne = () => {

    const {setPage}=useContext(RecoveryEtudExterne);

    const toDemandeEncadrement = (event) =>{
        event.preventDefault();
        setPage("demandeEncadExterne");
...
export default DashbordEtudExterne;