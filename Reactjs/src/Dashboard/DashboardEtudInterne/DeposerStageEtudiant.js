...
function DeposerStageEtud () {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post(`http://127.0.0.1:8000/Etudiant/AjouterStage/${identifiant}`, {                 
                Titre:Titre,
            ...
            if (response.data) {
                alert("Stage deposé avec succés");               
            } 
    ...
    <div id='page-top'>
        ...
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
            ...
            <div className="sidebar-heading text-white">               
                ...
                <span className='ml-2 cursor-pointer' >Deposer Stage</span>
            </div>
        ...
        <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
                ...
                onSubmit={handleSubmit} >
                    ...
                    <h4 className='text-bold font-bold font-medium mb-4'>Ajouter Stage </h4>

                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        <Form.Label>Titre <span className='text-red-500'>*</span></Form.Label>
                        <Form.Control type="text" 
                        required 
                        placeholder="Enter le titre su stage"  
                        style={{ width: '98%' }}
                        value={Titre}
                    ...
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        <Form.Label>Technologies <span className='text-red-500'>*</span></Form.Label>
                        <Form.Control type="text" 
                        required 
                        placeholder="Enter les technologies" 
                        style={{ width: '98%' }}
                        value={Technologie}
                    ...
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                    <Form.Label>Etablissement d'acceuil</Form.Label>
                        <Form.Control
                            type="text"
                            name="Societe"
                            value={Societe}
                            onChange={(e) => setSociete(e.target.value)}
                            placeholder="Etablissement d'acceuil"
                            className='mb-'                        
                        />
                    </Form.Group>

                    <Form.Group className="mb-3" controlId="formBasicEmail">
                    <Form.Label>Email de l'encadrant professionnel</Form.Label>
                        <Form.Control
                            type="email"
                            name="EncadrantProfessionnel"
                            value={EncadrantProfessionnel}
                            onChange={(e) => setEncadrantProfessionnel(e.target.value)}
                            placeholder="Email de l'encadrant professionel"
                            className='mb-'
                        />
                    </Form.Group>

                    <Form.Group className="mb-3" controlId="formBasicEmail">
                    <Form.Label>Email du responsable</Form.Label>
                        <Form.Control
                            type="email"
                            name="Responsable"
                            value={Responsable}
                            onChange={(e) => setResponsable(e.target.value)}
                            placeholder="Email de l'encadrant responsable"
                        />
                    </Form.Group>
      
                    <br />

                    <Button variant="primary" type='submit'  >Deposer Stage</Button>
                </Form>
                </div>
...
export default DeposerStageEtud;