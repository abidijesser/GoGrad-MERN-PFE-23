...
function MesEtudiants () {
    ...
    const [users, setUsers] = useState([]);
      ...
      const [usersvide, setUsersvide] = useState([
        {Nom: "Pas encore", Prenom: "Pas encore", Titre: "Pas encore", 
        Email: "Pas encore", Technologie: "Pas encore" },
    ...
    useEffect(() => {
        ...
        const fetchEtudiantsencadres = async () => {
            try {
                const response = await axios.get(`http://127.0.0.1:8000/Enseignant/getEtudiantsEncadres/${identifiant}`); 
                ...
                console.error('Erreur lors de la récupération des données Etudiants :', error);
            }

        };
        
        fetchEtudiantsencadres();
                    ...
                    <table  class="table table-bordered " >
                        ...
                        <thead class="table-primary " >
                            <tr className='bg-gray-200' >
                                ...
                                <th className="pr-5">Prenom</th>
                                <th className="pr-5">Stage</th>
