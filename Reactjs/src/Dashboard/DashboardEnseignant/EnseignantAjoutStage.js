...
function EnseignantAjoutStage() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post(`http://127.0.0.1:8000/Enseignant/AjouterStages/${identifiant}`,{                 
                Titre:Titre,
        ...
        <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
                ...
                onSubmit={handleSubmit}>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        <Form.Label>Technologies Recommandées</Form.Label>
                        <Form.Control type="text" 
                        required 
        ...
        <div className="modal-dialog" role="document">
            <div className="modal-content">
                ...
                <div className="modal-footer">
                    ...
                    <a className="btn btn-primary cursor-pointer" onClick={sedeconnecter} >Déconnexion</a>
                </div>
            </div>
        </div>
    </div>
...
export default EnseignantAjoutStage;