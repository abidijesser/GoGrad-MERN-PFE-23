...
function EnseignantDemandes () {

    const [users, setUsers] = useState([
        { id: 1, Nom: "Abidi", Prenom: "Jasser", Stage: "App Mobile de gestion de livraison",  Datedefin: "4/2/2023", Technologie: "React.js" },
        { id: 2, Nom: "youssef", Prenom: "Mey", Stage: "App Mobile de gestion tourisme",  Datedefin: "1/3/2023", Technologie: "Angular"  },
        { id: 3, Nom: "Belgacem", Prenom: "Rami", Stage: "Site-web E-commerce",  Datedefin: "22/2/2023", Technologie: "Vue.js"  },
        { id: 4, Nom: "Omezzine", Prenom: "Farah", Stage: "Plate-forme",  Datedefin: "15/2/2023", Technologie: "Flutter"  },
        { id: 4, Nom: "Amairi", Prenom: "Mokhtar", Stage: "Plate-forme de Education",  Datedefin: "15/2/2023", Technologie: "Flutter"  }
    ...
    <div id='page-top'>
        ...
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
            ...
            <div className="sidebar-heading text-white">               
                ...
                <span className='ml-2 cursor-pointer' > Mes Etudiants</span>
            </div>
            ...
            <div className="sidebar-heading text-white">               
                ...
                <span className='ml-2 cursor-pointer'  >Ajouter Stage</span>
            </div>
        ...
        <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
                ...
                style={{ width: '97%', height:'auto', border: '2px solid #E7E7E7' }}>
                    <div className="row p-3 m-0 bg-white rounded ml-3 mt-3" >

                    <h3 className='mb-4'>Mes Etudiants</h3>
                    <table  class="table table-bordered " >

                    
                        <thead  class="table-primary">
                            <tr className='bg-gray-200' >
                                <th className="pr-5 text-center">Etudiants</th>
                                <th className="pr-5 text-center">Stage</th>
                                <th className="pr-5 text-center">Technologie</th>
                                <th className="pr-5 text-center">Date</th>
                                <th className="pr-5 text-center">Réponse</th>
                        ...
                        <tbody style={{ marginTop: '20px' }}  >
                            ...
                            {users.map((user) => (                            
                                <tr  key={user.id}  >
                                    ...
                                    <td>{user.Stage}</td>
                                    <td className="text-center">{user.Technologie}</td>
                                    <td className="text-center">{user.Datedefin}</td>  
                                    <td>
...
export default EnseignantDemandes;