...
function ChefDepartementAjoutEsein() {
    ...
    const handleSubmit = async (event) => {
        ...
        if(Telephone.length === 8 ){
            ...
            if (validFirstDigits.includes(firstDigit)) {
                try {
                    const response = await axios.post(`http://127.0.0.1:8000/ChefDepart/AjouteEnseignant/${identifiant}`, {                 
                        Nom:Nom,
                        Prenom:Prenom,
                        Email:Email, 
                        Telephone:Telephone,
                    ...
                    alert("L'enseignant existe déja, changer l'email et essayer de nouveau.");
                    setEmail("");
                }
    ...
    <div id='page-top'>
        ...
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
            ...
            <div className="sidebar-heading text-white">
                ...
                <i className="fas fa-plus"></i>
                <span className='ml-2 cursor-pointer'>Ajouter Enseignant</span>
            </div>
        ...
        <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
                ...
                >
                    ...
                    <h4 className='text-bold font-bold font-medium mb-4'>Ajouter Enseignant </h4>
                    ...
                    <Button variant="primary" className='mt-3 py-2 px-4' type='submit'>Ajouter</Button>
                </Form>
                </div>
...
export default ChefDepartementAjoutEsein;