...
function ChefDepartementGereUsers () {
    ...
    const [users, setUsers] = useState
        ([
            { EtudiantID: 1, Nom: "Nasri", Prenom: "Ahmed", Email:"Nasriahmed@gmail.com", Filiere: "LGLSI", Niveau: "3", StatutEncadrement: "Affecté" },
            { EtudiantID: 2, Nom: "Rim", Prenom: "Youssef", Email:"rimyoussef00@gmail.com", Filiere: "MPSSI", Niveau: "1", StatutEncadrement: "Affecté"  },
            { EtudiantID: 3, Nom: "Imen", Prenom: "Belhaj", Email:"imenbelhaj10@gmail.com", Filiere: "LGLSI", Niveau: "3", StatutEncadrement: "Non affecté"  },
            { EtudiantID: 3, Nom: "Abidi", Prenom: "Aziz", Email:"abidiaziz@gmail.com", Filiere: "MPDS", Niveau: "1", StatutEncadrement: "Affecté"  },
            { EtudiantID: 3, Nom: "Ghodhbani", Prenom: "Amin", Email:"aminghofhbani10@gmail.com", Filiere: "MRMSRA", Niveau: "1", StatutEncadrement: "Non affecté"  },
            { EtudiantID: 3, Nom: "Belgacem", Prenom: "Firas", Email:"firasbelgacem@outlook.com", Filiere: "LGLSI", Niveau: "3", StatutEncadrement: "Non affecté"  },
            { EtudiantID: 3, Nom: "Arbi", Prenom: "Aya", Email:"arbiaya@gmail.com", Filiere: "MPDS", Niveau: "1", StatutEncadrement: "Affecté"  },              
        ]);
    ...
    useEffect(() => {
        ...
        const fetchListeUsers = async () => {
          try {
            const response = await axios.get(`http://127.0.0.1:8000/ChefDepart/GetEtudiantsAvecStatus/${identifiant}`) ; 

            const ListeUsers = response.data;
            console.log(ListeUsers);
            setUsers(ListeUsers);
            setCopieusers(ListeUsers);
    ...
    const handleSubmit = async (event) => {
        ...
        console.log(UserID)
        try {
            const response = await axios.patch(`http://127.0.0.1:8000/ChefDepart/UpdateEtudiantByID/${identifiant}/${UserID}`, {
    ...
    const DeleteUser = async (userid, UserNom, UserPrenom) => {
        ...
        if(result){
            try {    
                ...
                const response = await axios.delete(`http://127.0.0.1:8000/ChefDepart/supprimerEtudiant/${identifiant}/Etudiant/${userid}` );
    ...
    const Sort = async() => {
        ...
        if (sortby === 'Affecté'){
            ...
            try {
                const response = await axios.get(`http://127.0.0.1:8000/ChefDepart/GetEtudiantAffe/${identifiant}`);
        ...
        else if (sortby === 'NonAffecté') {

            try {
                const response = await axios.get(`http://127.0.0.1:8000/ChefDepart/getEtudiantNonAffecte/${identifiant}`);
    ...
    <div id='page-top'>
        ...
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
            ...
            <i className="fas fa-users"></i>
                <span className='ml-2 cursor-pointer' >Gerer Etudiants</span>
            </div>
        ...
        <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
                ...
                style={{ width: '97%', height:'85%', border: '2px solid #E7E7E7' }}>
                    ...
                    <h4 className='text-bold font-bold font-medium mb-4'>Etudiants</h4>
                        ...
                        <div className='d-flex align-items-center justify-content-center '>
                            <Form.Select
                                ...
                                style={{ width: '30%', marginLeft: '665px' }}
                                required
                                ...
                                <option value="Affecté">Etudiant affecté</option>
                                <option value="NonAffecté">Etudiant non affecté</option>
                                <option value="Annulé">Annulé . . .</option>
                                
                            </Form.Select>

                            <boutton type='boutton' 
                            onClick={Sort} 
                            className="bg-blue-500  text-white  ml-3 text-center flex items-center justify-center cursor-pointer hover:bg-blue-600"                           
                            style={{ height: '36px', width: '80px', borderRadius: '5px' }}
                            >Trier</boutton>
                    ...
                    <table class="table-bordered table">
                        ...
                        <tbody>
                            ...
                            {users.map((user) => (
                                ...
                                <tr  key={user.id}  >
                                    <td style={{width: '180px'}}>{user.Prenom} {user.Nom}</td>
                                    <td style={{width: '300px'}}>{user.Email}</td>        
                                    <td style={{width: '150px'}}>{user.Filiere}</td>
                                    <td style={{width: '100px'}}>{user.Niveau}</td>
                                    <td style={{width: '150px'}}>{user.StatutEncadrement}</td>
                                    ...
                                    <td> 
                                        ...
                                        <button 
                                            ...
                                            className="hover:bg-blue-100 rounded mr-4"
                                            data-te-toggle="modal"
                                            data-te-target="#exampleModalScrollable"
                                            data-te-ripple-init
                                            data-te-ripple-color="light"  
                                            onClick={() => handlechange(user.EtudiantID, user.Nom, user.Prenom)}
                                            >
                                            ...
                                            >
                                                ...
                                                <Form.Group className="mb-2" controlId="formBasicEmail">
                                                    ...
                                                    >    
                                                        ...
                                                        <option value="MRMSRA1">MRMSRA1</option>
                                                        <option value="MPISI1">MPISI1</option>
                                                        <option value="MPTS1">MPTS1</option>
                                        ...
                                        onClick={() => DeleteUser(user.EtudiantID, user.Nom, user.Prenom)}
                                        >
...
export default ChefDepartementGereUsers;